...
target_neurons = 'Z:\ben\20170818_full_shifted\';
stl_neurons = 'C:\Users\benjaminp\Desktop\NeuronReconstructions\20170818_just_dstl2\';

send_text = true;
opts = struct('verbose', true, 'coarse_progress', false, 'send_text', false,'d100', false, 'd10', false, 'shift', [40960 30720 0] , 'reduce_size', true);
...
target_neurons = 'Z:\ben\20170818_full_unshifted\';
opts = struct('verbose', true, 'coarse_progress', false, 'send_text', false,'d100', false, 'd10', false, 'shift', [0 0 0] , 'reduce_size', false);
